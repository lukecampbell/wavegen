 ...
 *      Author: unkown (I DID NOT WRITE THIS!)
 */
...
fft(double *x,double *re,double *im,int ndat)
{
  int i;
  double dT,T,dfreq,*pd;
...
ifft(double *x,double *re,double *im,int ndat)
{
  int i,j,l;
  double dT,freq,dfreq,tmp,*pd;
...
spectrum(double *x,double *y,int ndat)
{
  int i;
...
colleration(double *x,double *y,int ndat)
{
  /* auto colleration */
  int i;
  double *im;
...
cepstrum(double *x,double *y,int ndat)
{
  int i;
...
fft_cal(double *x,double *re,double *im,int ndat)
{
  int g,h,i,j,k,l,m,n,p,q;
  /* double a,b,tmp,*pd,s[FFT_MAX],c[FFT_MAX]; */
  double a,b,tmp,*pd,*s,*c;
...
dft_cal(double *x,double *re,double *im,int ndat)
{
  int i,j,m;
  double *s,*c;
  double *rei,*imi;
